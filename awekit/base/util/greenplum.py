...
class Greenplum(Database):
    ...
    def sqlcmd_stmt(self, stmt, out_file_path=None, show_header=True, encoding=base.UTF8, delimiter=Database.COL_SEPARATOR):
    ...
    def sqlcmd_file(self, sql_file_path, out_file_path=None, show_header=True, encoding=base.UTF8, delimiter=Database.COL_SEPARATOR):
    ...
    def sqlcmd(self, stmt_or_file: str, out_file_path=None, show_header=True, encoding=base.UTF8, delimiter=Database.COL_SEPARATOR, is_stmt=True):
    ...
    def export_query(self, export_sql: str, local_file_path: str, remote_file_path: str,
                     jump_host=None, jump_port=22, jump_user=None, jump_pwd=None, encoding=base.UTF8):
        dt_flag = self.get_timestamp()
