...
class Database(object):
    ...
    def execute_cmd(self, cmd, dt_flag=None, encoding=base.UTF8):
        b_t = time.time()
        cmd_id = dt_flag
        if cmd_id is None:
    ...
    def sqlcmd_stmt(self, stmt, out_file_path=None, show_header=True, encoding=base.UTF8, delimiter=COL_SEPARATOR):
        pass

    def sqlcmd_file(self, sql_file_path, out_file_path=None, show_header=True, encoding=base.UTF8, delimiter=COL_SEPARATOR):
        pass

    def sqlcmd(self, stmt_or_file: str, out_file_path=None, show_header=True, encoding=base.UTF8, delimiter=COL_SEPARATOR, is_stmt=True):
        pass
